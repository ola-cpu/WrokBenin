<div class="inline-block relative">
	...
	<input class="bg-gray-200 text-gray-700 border-2 focus:outline-none placeholder-gray-500 px-2 py-1 rounded-full mr-3 w-56" placeholder="Rechercher une mission..." wire:model="query">
